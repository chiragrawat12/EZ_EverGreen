var stateObject = {
    ...
    'Congo': ['Bouenza Department',
        ...
        'Pool Department',
        'Sangha Department'],
    'Congo The Democratic Republic Of The': ['Bandundu Province',
        'Bas-Congo province',
        'Bas-Uele',
        'Équateur',
    ...
    "Cote D'Ivoire (Ivory Coast)": ['Abidjan',
        ...
        'Yamoussoukro',
        'Zanzan Region'],
    'Croatia (Hrvatska)': ['Bjelovar-Bilogora County',
    ...
    'Cyprus': ['Famagusta District',
        ...
        'Nicosia District',
        'Paphos District'],
    'Czech Republic': ['Benešov District',
        'Beroun District',
        'Blansko District',
        'Břeclav District',
        'Brno-City District',
...
window.onload = function () {
    ...
    for (var cntry in stateObject) {
        country.options[country.options.length] = new Option(cntry, cntry);
    }
    country.onchange = function () {
        state.length = 1;
        state.options[0].selected = true;
        if (this.selectedIndex < 1) return;
        var sts = stateObject[country.value];
        for (var i = 0; i < sts.length; i++) {
            state.options[state.options.length] = new Option(sts[i], sts[i]);
        }
    }
}